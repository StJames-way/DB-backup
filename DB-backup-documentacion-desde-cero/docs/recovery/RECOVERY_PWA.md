...
crypted_backups/                              nombre incorrecto: no usar
...
> El directorio correcto es `encrypted_backups/`. La línea `crypted_backups/`
> anterior se muestra deliberadamente como ejemplo de un nombre que debe ser
> rechazado; no crees ni uses ese directorio.
...
Después sigue [`disaster-recovery.md`](../instructions/06-recovery-drill.md) para restaurar en
